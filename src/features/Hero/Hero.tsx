...
export default function Hero() {
  return (
    ...
    />
    <div className="absolute top-0 justify-center space-y-4 left-0 right-0 bottom-0 flex flex-col  items-start   text-center w-full h-full px-16" style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
