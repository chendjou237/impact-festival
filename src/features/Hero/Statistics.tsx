...
const Table = () => {
  return (
    ...
    <div className="grid grid-cols-4 gap-x-3 gap-y-3 md:gap-x-12 md:gap-y-6  ">
        ...
        <div className=' bg-diamond  px-2 py-2 md:py-4 rounded-md font-biko  font-semibold text-lg w-20 md:justify-start justify-center md:w-40  '> 50</div>
        ...
        <div className=' bg-gold  px-2 py-2 md:py-4 rounded-md font-biko text-white font-semibold  text-lg w-20 md:justify-start justify-center md:w-40  '> 300</div>
        ...
        <div className=' bg-silver  px-2 py-2 md:py-4 rounded-md font-biko  font-semibold text-lg w-20 md:justify-start justify-center md:w-40  '> 100</div>
        ...
        <div className=' bg-silver  px-2 py-2 md:py-4 rounded-md font-biko  font-semibold text-lg w-20 md:justify-start justify-center md:w-40  '> 70</div>
        ...
        <div className=' bg-general  px-2 py-2 md:py-4 rounded-md font-biko text-white font-semibold text-lg w-20 md:justify-start justify-center md:w-40  '> 100</div>
        


        <div className=' bg-general  px-2 py-2 md:py-4 rounded-md font-biko  text-white font-semibold text-lg w-20 md:justify-start justify-center md:w-40  '> 50</div>
