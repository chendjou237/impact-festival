...
const Table = () => {
  return (
    ...
    <div className="grid grid-cols-4 gap-x-3 gap-y-3 md:gap-x-12 md:gap-y-6  ">
        ...
        enter '><div className="rounded-full font-biko  mr-2 p-1 self-center bg-black"><ReactSVG src={diamond} /></div> <span className="hidden md:block font-cinzel">DIAMOND</span></div>
        ...
        enter  '><div className="rounded-full font-biko mr-2  p-1 self-center bg-black"><ReactSVG src={silver} /></div>  <span className="hidden md:block font-cinzel">SILVER</span></div>
